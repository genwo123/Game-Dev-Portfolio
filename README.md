...
<details>
<summary><strong>하모니아 프로젝트</strong> | 7인 협업 | 1인칭 퍼즐 어드벤처 게임
<br>주요 역할: 메인 프로그래머, 기술 총괄
<br>핵심 역량: 시스템 설계, 협업 관리, 퍼즐 로직 구현</summary>

> "건우님은 복잡한 퍼즐 시스템을 체계적으로 설계하고 구현해주셨습니다. 특히 기획 의도를 정확히 파악하고 기술적으로 구현해주는 능력이 뛰어났습니다."
>
> *- ○○○, 게임 기획자*

> "개발 과정에서 발생하는 기술적 문제들을 빠르게 해결해주시고, 아트 에셋 통합 과정에서도 많은 도움을 주셨습니다. 비개발자도 이해하기 쉽게 설명해주셔서 협업이 수월했습니다."
>
> *- ○○○, 3D 아티스트*

> "Enhanced Input System과 대화 시스템 구현에서 사용자 경험을 깊이 고려한 설계를 해주셨습니다. 게임의 몰입감을 높이는 기술적 완성도가 인상적이었습니다."
>
> *- ○○○, 사운드 디자이너*
