...
## 김건우 (Gunwoo Kim)
안녕하세요, 개발자를 꿈꾸는 **김건우**입니다. 이 레포지토리는 제가 참여한 다양한 게임 및 프로젝트들을 소개하는 포트폴리오입니다. 
게임 개발은 주로 Unreal Engine을 활용하여 개발했으며, 게임 플레이 로직과 시스템 구현에 집중했습니다. 각 프로젝트를 클릭하시면 자세한 내용을 확인하실 수 있습니다.
...
<details>
<summary><strong>하모니아 프로젝트</strong> | 6인 협업 | 언리얼 퍼즐 게임 개발
<br>주요 역할: 단독 프로그래머 (10개월)
<br>핵심 역량: DataTable 시스템 설계, Git 협업 환경 구축, 비개발자 소통</summary>

> "Git과 같은 협업용 설명도 해주시고 전반적으로 개발하면서 디자이너측에 맞춰서 해주는게 너무 좋았습니다. 집중해서 할 수 있어 좋았습니다."
>
> *- 박지우, 팀장 및 모델 디자이너*

> "원하는 의도대로 나올 수 있도록 만들어주시고 주기적으로 소통하면서 디테일을 잡아주시는게 너무 좋았습니다."
>
> *- 류지원, 디자이너*

> "필요할때 빠르게 일처리를 해주시고 디테일적인 부분, 라이팅 부분을 세세하게 맞춰서 해주셔서 좋았습니다."
>
> *- 박소율, 디자이너*

> "실제 제작 중에 방송을 켜주면서 영감을 주고 다양한 자료 및 데이터 제공해주셔서 너무 도움되었습니다."
>
> *- 박세이, 사운드 디자이너*

> "대화 테이블이나 스토리 보드를 드리면 추가작업 없이 변환해주셔서 편했고, 회의마다 좋은 아이디어 내주셔서 영감을 많이 받았습니다."
>
> *- 정영서, 스토리 및 퍼즐 기획*
</details>
